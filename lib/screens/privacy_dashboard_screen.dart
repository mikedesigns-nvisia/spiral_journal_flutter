      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.privacy_tip, color: AppTheme.primaryOrange, size: 28),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SwitchListTile(
              title: const Text('Personalized AI Insights'),
              subtitle: const Text(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.pin, color: AppTheme.primaryOrange),
            ...
            ListTile(
              leading: Icon(Icons.fingerprint, color: AppTheme.primaryOrange),
            ...
            ListTile(
              leading: Icon(Icons.enhanced_encryption, color: AppTheme.primaryOrange),
            ...
            ListTile(
              leading: Icon(Icons.key, color: AppTheme.primaryOrange),
